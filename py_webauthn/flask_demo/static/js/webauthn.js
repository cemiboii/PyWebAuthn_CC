...
const didClickRegister = async (e) => {
    ...
    try {
        ...
        return console.error("Registrierung fehlgeschlagen:", err);
    }
    ...
    try {
        ...
        alert("Servervalidierung fehlgeschlagen: " + err)
        return console.error("Servervalidierung fehlgeschlagen: ", err);
    }
...
const didClickLogin = async (e) => {
    ...
    try {
        ...
        return console.error("Anmeldung fehlgeschlagen: ", err);
    }
    ...
    try {
        ...
        alert("Fehler bei der Credential-Erstellung: " + err)
        return console.error("Fehler bei der Credential-Erstellung: ", err);
    }
    ...
    try {
        ...
        alert("Fehler bei der Assertion-Validierung auf dem Server: " + err)
        return console.error("Fehler bei der Assertion-Validierung auf dem Server: ", err);
    }
